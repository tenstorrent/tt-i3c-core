...
`ifndef I3C_IBI_SVA_PROBE_SV
`define I3C_IBI_SVA_PROBE_SV

class i3c_ibi_sva_probe extends uvm_subscriber #(i3c_ibi_item);
  `uvm_component_utils(i3c_ibi_sva_probe)

  virtual i3c_tb_if vif;

  function new(string name = "i3c_ibi_sva_probe",
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (vif == null)
      `uvm_fatal("IBI_SVA_PROBE_VIF",
                 "Normalized IBI SVA probe requires i3c_tb_if")
  endfunction
...
endclass : i3c_ibi_sva_probe

`endif // I3C_IBI_SVA_PROBE_SV
