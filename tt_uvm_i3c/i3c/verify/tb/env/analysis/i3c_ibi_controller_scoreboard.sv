...
//
// File        : i3c_ibi_controller_scoreboard.sv
...
`ifndef I3C_IBI_CONTROLLER_SCOREBOARD_SV
`define I3C_IBI_CONTROLLER_SCOREBOARD_SV
...
class i3c_ibi_controller_scoreboard extends uvm_scoreboard;
  `uvm_component_utils(i3c_ibi_controller_scoreboard)

  uvm_analysis_imp_ibi_ctrl_sb_expected #(
    i3c_ibi_expected_item,
    i3c_ibi_controller_scoreboard
  ) expected_export;
  uvm_analysis_imp_ibi_ctrl_sb_actual #(
    i3c_ibi_controller_actual_item,
    i3c_ibi_controller_scoreboard
  ) actual_export;
  ...
  protected i3c_ibi_controller_actual_item actual_q[$];
  int unsigned match_count;
  int unsigned mismatch_count;
  protected bit pio_transfer_error_assert_seen;
  protected bit pio_transfer_error_clear_pending;

  function new(string name = "i3c_ibi_controller_scoreboard",
  ...
  protected function string actual_key(
      i3c_ibi_controller_actual_item item);
  ...
  protected function void emit_pio_transfer_error_irq(
    ...
    item = i3c_ibi_item::type_id::create(
  ...
  protected function void emit_coverage(
      i3c_ibi_expected_item expected,
      i3c_ibi_controller_actual_item actual);
    i3c_ibi_item item;

    item = i3c_ibi_item::type_id::create("controller_attempt");
    ...
    item = i3c_ibi_item::type_id::create("controller_completion");
    ...
    item = i3c_ibi_item::type_id::create("controller_queue_irq");
    item.evt_kind = IBI_EVT_QUEUE_IRQ;
    item.transaction_id = expected.transaction_id;
    ...
    // The reviewed native Controller prevents overflow by NACKing an IBI when the
...
endclass : i3c_ibi_controller_scoreboard

`endif // I3C_IBI_CONTROLLER_SCOREBOARD_SV
