...
`ifndef I3C_IBI_OBSERVER_SV
`define I3C_IBI_OBSERVER_SV
...
// owned by i3c_ibi_predictor so checking and observation cannot share a
// descriptor correlation state-machine.
class i3c_ibi_observer extends uvm_component;
  `uvm_component_utils(i3c_ibi_observer)

  uvm_analysis_imp_ibi_actual_axi #(
    axi4lite_item #(TB_ADDR_WIDTH, TB_DATA_WIDTH), i3c_ibi_observer
  ) axi_export;
  uvm_analysis_imp_ibi_actual_bus #(
    i3c_item, i3c_ibi_observer
  ) bus_export;
  uvm_analysis_imp_ibi_actual_host #(
    i3c_host_ibi_observation, i3c_ibi_observer
  ) host_export;
  uvm_analysis_port #(i3c_ibi_actual_item) actual_port;
  ...
  protected i3c_ibi_passive_item passive_q[$];
  ...
  function new(string name = "i3c_ibi_observer",
  ...
  protected function void emit_attempt(i3c_ibi_actual_item actual);
    i3c_ibi_item item;
    ...
    item = i3c_ibi_item::type_id::create("attempt_item");
  ...
  protected function void emit_completion(i3c_ibi_actual_item actual);
    i3c_ibi_item item;

    item = i3c_ibi_item::type_id::create("completion_item");
  ...
  protected function void complete_address_arb_loss();
    ...
    actual = i3c_ibi_actual_item::type_id::create(
  ...
  virtual function void write_ibi_actual_host(
    ...
    actual = i3c_ibi_actual_item::type_id::create("actual_item");
    actual.transaction_id = next_transaction_id++;
...
endclass : i3c_ibi_observer

`endif // I3C_IBI_OBSERVER_SV
