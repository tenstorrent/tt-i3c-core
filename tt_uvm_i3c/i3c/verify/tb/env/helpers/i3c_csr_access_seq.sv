...
class i3c_csr_access_seq #(int ADDR_WIDTH = TB_ADDR_WIDTH,
                               int DATA_WIDTH = TB_DATA_WIDTH)
  extends axi4lite_base_seq #(ADDR_WIDTH, DATA_WIDTH);

    `uvm_object_param_utils(i3c_csr_access_seq #(ADDR_WIDTH, DATA_WIDTH))
    ...
    function new(string name = "i3c_csr_access_seq");
        super.new(name);
