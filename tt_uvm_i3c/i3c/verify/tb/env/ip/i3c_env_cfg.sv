...
//
// File        : i3c_env_cfg.sv
// Description : Configuration object for the I3C verification environment.
...
typedef enum bit {
    I3C_IBI_DUT_TARGET     = 1'b0,
    I3C_IBI_DUT_CONTROLLER = 1'b1
} i3c_ibi_dut_role_e;

class i3c_env_cfg extends uvm_object;
    `uvm_object_utils(i3c_env_cfg)
    ...
    i3c_csr_scoreboard_cfg #(TB_ADDR_WIDTH, TB_DATA_WIDTH) scoreboard_cfg;
    bit has_ral = 1'b1;
    uvm_reg_cvr_t ral_coverage_models = UVM_NO_COVERAGE;
    i3c_ibi_dut_role_e ibi_dut_role = I3C_IBI_DUT_TARGET;
