...
//
// File        : i3c_base_vseq.sv
// Description : Base virtual sequence for I3C verification environment.
// Authors     : Huynh Pham Anh Duy, Thai Hai Dang
// Date        : 2026-07-18
//
// *****************************************************************************

class i3c_base_vseq extends uvm_sequence #(uvm_sequence_item);
    ...
    virtual task pre_body();
        if (vseq_ctx == null &&
            !uvm_config_db#(i3c_vseq_context)::get(
                null, "uvm_test_top", "context", vseq_ctx)) begin
            `uvm_fatal(get_type_name(), "Missing i3c_vseq_context")
        end
    endtask
    ...
    virtual function i3c_csr_helper #(TB_ADDR_WIDTH, TB_DATA_WIDTH)
        get_i3c_csr_helper();
...
`ifdef I3C_DV_NATIVE_RAL
    virtual function i3c_ral_model get_i3c_ral_model();
