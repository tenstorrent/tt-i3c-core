...
//
// File        : smc_i3c_ibi_controller_rx_multi_target_vseq.sv
...
`ifndef SMC_I3C_IBI_CONTROLLER_RX_MULTI_TARGET_VSEQ_SV
`define SMC_I3C_IBI_CONTROLLER_RX_MULTI_TARGET_VSEQ_SV

class smc_i3c_ibi_controller_rx_multi_target_vseq extends smc_i3c_ibi_base_vseq;
  `uvm_object_utils(smc_i3c_ibi_controller_rx_multi_target_vseq)

  localparam int unsigned TARGET_COUNT = 4;

  function new(string name = "smc_i3c_ibi_controller_rx_multi_target_vseq");
    super.new(name);
  endfunction
...
`ifdef SMC_USE_I3C_RAL
  ...
  protected task service_target(
      input smc_i3c_controller_hci_helper #(TB_ADDR_WIDTH, TB_DATA_WIDTH)
        hci_helper,
    ...
    retry_seq = smc_i3c_target_send_ibi_seq::type_id::create(
    ...
    armed_event = uvm_event_pool::get_global(
      $sformatf("%s_%0d", SMC_I3C_TARGET_IBI_SLOT_ARMED_EVENT, slot));
    armed_event.reset();
    retry_done = 1'b0;
    fork : target_retry
      begin
...
`ifdef SMC_USE_I3C_RAL
    begin
      smc_i3c_controller_hci_helper #(TB_ADDR_WIDTH, TB_DATA_WIDTH) hci_helper;
      smc_i3c_target_send_ibi_seq target_seq_0;
      smc_i3c_target_send_ibi_seq target_seq_1;
      smc_i3c_target_send_ibi_seq target_seq_2;
      smc_i3c_target_send_ibi_seq target_seq_3;
      uvm_event armed_0;
      uvm_event armed_1;
      uvm_event armed_2;
      uvm_event armed_3;
      ...
      target_seq_0 = smc_i3c_target_send_ibi_seq::type_id::create("target_seq_0");
      target_seq_1 = smc_i3c_target_send_ibi_seq::type_id::create("target_seq_1");
      target_seq_2 = smc_i3c_target_send_ibi_seq::type_id::create("target_seq_2");
      target_seq_3 = smc_i3c_target_send_ibi_seq::type_id::create("target_seq_3");
...
`endif
  endtask
endclass : smc_i3c_ibi_controller_rx_multi_target_vseq

`endif // SMC_I3C_IBI_CONTROLLER_RX_MULTI_TARGET_VSEQ_SV
