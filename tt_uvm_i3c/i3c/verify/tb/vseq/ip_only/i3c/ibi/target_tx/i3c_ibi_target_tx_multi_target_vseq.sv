...
//
// File        : i3c_ibi_target_tx_multi_target_vseq.sv
...
`ifndef I3C_IBI_TARGET_TX_MULTI_TARGET_VSEQ_SV
`define I3C_IBI_TARGET_TX_MULTI_TARGET_VSEQ_SV

class i3c_ibi_target_tx_multi_target_vseq extends i3c_ibi_base_vseq;
  `uvm_object_utils(i3c_ibi_target_tx_multi_target_vseq)

  function new(string name = "i3c_ibi_target_tx_multi_target_vseq");
    super.new(name);
  endfunction
...
`ifdef I3C_DV_NATIVE_RAL
  protected task check_host_response(
      input i3c_host_respond_ibi_seq host_seq,
  ...
  virtual task body();
    ...
    if (!vseq_ctx.cfg.has_rtl)
      `uvm_fatal("IBI_MULTI_MODE",
                 "i3c_ibi_target_tx_multi_target_test requires native I3C RTL mode")
    if (vseq_ctx.cfg.ibi_dut_role != I3C_IBI_DUT_TARGET)
      `uvm_fatal("IBI_MULTI_ROLE",
                 "i3c_ibi_target_tx_multi_target_test verifies DUT-Target transmit behavior")

`ifndef I3C_DV_NATIVE_RTL
    `uvm_fatal("IBI_MULTI_RTL_BUILD",
               "Multi-Target IBI arbitration requires I3C_DV_NATIVE_RTL")
`elsif I3C_DV_NATIVE_RAL
    begin
      i3c_ral_model ral;
      i3c_host_respond_ibi_seq winner_host_seq;
      i3c_host_respond_ibi_seq loser_host_seq;
      i3c_target_send_ibi_seq competitor_seq;
      i3c_target_send_ibi_seq tertiary_seq;
      i3c_target_send_ibi_seq competitor_retry_seq;
      i3c_target_send_ibi_seq tertiary_retry_seq;
      ...
      winner_host_seq = i3c_host_respond_ibi_seq::type_id::create(
        "winner_host_seq");
      winner_host_seq.ibi_ack = 1'b1;
      winner_host_seq.rx_byte_count = 1;
      competitor_seq = i3c_target_send_ibi_seq::type_id::create(
        "competitor_seq");
      ...
      tertiary_seq = i3c_target_send_ibi_seq::type_id::create(
        "tertiary_seq");
      ...
      loser_host_seq = i3c_host_respond_ibi_seq::type_id::create(
        "loser_host_seq");
      loser_host_seq.ibi_ack = 1'b1;
      loser_host_seq.rx_byte_count = 1;
      competitor_retry_seq = i3c_target_send_ibi_seq::type_id::create(
      ...
      loser_host_seq.ibi_ack = 1'b1;
      loser_host_seq.rx_byte_count = 1;
      tertiary_retry_seq = i3c_target_send_ibi_seq::type_id::create(
        "tertiary_retry_seq");
...
`else
    `uvm_fatal("IBI_MULTI_RAL_BUILD",
               "Multi-Target IBI arbitration requires I3C_DV_NATIVE_RAL")
`endif
  endtask
endclass : i3c_ibi_target_tx_multi_target_vseq

`endif // I3C_IBI_TARGET_TX_MULTI_TARGET_VSEQ_SV
