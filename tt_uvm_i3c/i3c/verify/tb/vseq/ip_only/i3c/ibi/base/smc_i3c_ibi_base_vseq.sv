...
class smc_i3c_ibi_base_vseq extends smc_peripherals_base_vseq;
  ...
  localparam int unsigned BCR_IBI_CAPABLE_BIT = SMC_I3C_BCR_IBI_CAPABLE_BIT;
  localparam int unsigned BCR_MDB_CAPABLE_BIT = SMC_I3C_BCR_MDB_CAPABLE_BIT;
...
`ifdef SMC_USE_I3C_RAL
  `include "smc_i3c_ibi_ral_tasks.svh"

`ifdef SMC_USE_I3C_RTL
  `include "smc_i3c_ibi_bus_prime_tasks.svh"
`endif
`endif
