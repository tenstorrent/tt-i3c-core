...
//
// File        : smc_i3c_ibi_controller_rx_content_vseq.sv
...
`ifndef SMC_I3C_IBI_CONTROLLER_RX_CONTENT_VSEQ_SV
`define SMC_I3C_IBI_CONTROLLER_RX_CONTENT_VSEQ_SV
...
class smc_i3c_ibi_controller_rx_content_vseq extends
    smc_i3c_ibi_controller_rx_basic_vseq;
  `uvm_object_utils(smc_i3c_ibi_controller_rx_content_vseq)

  function new(string name = "smc_i3c_ibi_controller_rx_content_vseq");
    super.new(name);
  endfunction
...
endclass : smc_i3c_ibi_controller_rx_content_vseq

`endif // SMC_I3C_IBI_CONTROLLER_RX_CONTENT_VSEQ_SV
