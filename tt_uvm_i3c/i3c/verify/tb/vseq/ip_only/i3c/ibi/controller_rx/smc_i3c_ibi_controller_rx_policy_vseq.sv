...
//
// File        : smc_i3c_ibi_controller_rx_policy_vseq.sv
...
`ifndef SMC_I3C_IBI_CONTROLLER_RX_POLICY_VSEQ_SV
`define SMC_I3C_IBI_CONTROLLER_RX_POLICY_VSEQ_SV
...
// (smc_i3c_ibi_controller_rx_policy_test.sv) for the specific RTL bugs.
class smc_i3c_ibi_controller_rx_policy_vseq extends smc_i3c_ibi_base_vseq;
  `uvm_object_utils(smc_i3c_ibi_controller_rx_policy_vseq)
  ...
  function new(string name = "smc_i3c_ibi_controller_rx_policy_vseq");
    super.new(name);
...
`endif
  endtask
endclass : smc_i3c_ibi_controller_rx_policy_vseq

`endif // SMC_I3C_IBI_CONTROLLER_RX_POLICY_VSEQ_SV
