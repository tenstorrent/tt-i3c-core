...
//
// File        : i3c_ibi_controller_rx_soft_rst_selfclear_vseq.sv
...
`ifndef I3C_IBI_CONTROLLER_RX_SOFT_RST_SELFCLEAR_VSEQ_SV
`define I3C_IBI_CONTROLLER_RX_SOFT_RST_SELFCLEAR_VSEQ_SV
...
class i3c_ibi_controller_rx_soft_rst_selfclear_vseq extends i3c_ibi_base_vseq;
  `uvm_object_utils(i3c_ibi_controller_rx_soft_rst_selfclear_vseq)
  ...
  function new(string name = "i3c_ibi_controller_rx_soft_rst_selfclear_vseq");
    super.new(name);
  endfunction
  ...
  virtual task body();
    ...
    if (!vseq_ctx.cfg.has_rtl)
      `uvm_fatal("IBI_SOFT_RST_MODE",
                 "SOFT_RST inertness test requires native I3C RTL mode")
...
`else
    `uvm_fatal("IBI_SOFT_RST_RAL_BUILD",
               "SOFT_RST inertness test requires I3C_DV_NATIVE_RAL")
`endif
`else
    `uvm_fatal("IBI_SOFT_RST_RTL_BUILD",
               "SOFT_RST inertness test requires I3C_DV_NATIVE_RTL")
`endif
  endtask
endclass : i3c_ibi_controller_rx_soft_rst_selfclear_vseq

`endif // I3C_IBI_CONTROLLER_RX_SOFT_RST_SELFCLEAR_VSEQ_SV
