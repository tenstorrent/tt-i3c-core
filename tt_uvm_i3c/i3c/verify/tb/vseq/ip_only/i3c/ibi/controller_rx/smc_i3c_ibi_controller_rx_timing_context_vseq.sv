...
//
// File        : smc_i3c_ibi_controller_rx_timing_context_vseq.sv
...
`ifndef SMC_I3C_IBI_CONTROLLER_RX_TIMING_CONTEXT_VSEQ_SV
`define SMC_I3C_IBI_CONTROLLER_RX_TIMING_CONTEXT_VSEQ_SV

class smc_i3c_ibi_controller_rx_timing_context_vseq extends
    smc_i3c_ibi_base_vseq;
  `uvm_object_utils(smc_i3c_ibi_controller_rx_timing_context_vseq)
  ...
  function new(
      string name = "smc_i3c_ibi_controller_rx_timing_context_vseq");
    super.new(name);
...
`endif
  endtask
endclass : smc_i3c_ibi_controller_rx_timing_context_vseq

`endif // SMC_I3C_IBI_CONTROLLER_RX_TIMING_CONTEXT_VSEQ_SV
