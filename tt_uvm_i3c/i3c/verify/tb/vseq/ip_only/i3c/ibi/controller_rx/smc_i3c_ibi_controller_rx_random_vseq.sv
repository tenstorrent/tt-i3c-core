...
//
// File        : smc_i3c_ibi_controller_rx_random_vseq.sv
...
`ifndef SMC_I3C_IBI_CONTROLLER_RX_RANDOM_VSEQ_SV
`define SMC_I3C_IBI_CONTROLLER_RX_RANDOM_VSEQ_SV

class smc_i3c_ibi_controller_rx_random_vseq extends
    smc_i3c_ibi_controller_rx_policy_vseq;
  `uvm_object_utils(smc_i3c_ibi_controller_rx_random_vseq)

  protected smc_i3c_ibi_random_plan random_plan;

  function new(string name = "smc_i3c_ibi_controller_rx_random_vseq");
    super.new(name);
  endfunction
...
`ifdef SMC_USE_I3C_RAL
  protected virtual task prepare_policy_scenarios();
    ...
    random_plan = smc_i3c_ibi_random_plan::type_id::create(
      "controller_plan");
...
`endif
`endif
endclass : smc_i3c_ibi_controller_rx_random_vseq

`endif // SMC_I3C_IBI_CONTROLLER_RX_RANDOM_VSEQ_SV
