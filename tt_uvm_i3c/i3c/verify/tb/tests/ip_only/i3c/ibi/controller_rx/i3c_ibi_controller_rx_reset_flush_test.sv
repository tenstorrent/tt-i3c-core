...
//
// File        : i3c_ibi_controller_rx_reset_flush_test.sv
...
`ifndef I3C_IBI_CONTROLLER_RX_RESET_FLUSH_TEST_SV
`define I3C_IBI_CONTROLLER_RX_RESET_FLUSH_TEST_SV

// Implements the Controller-RX half of test plan row 04_Tests!r24
// (i3c_ibi_reset_flush_test, "HCI IBI FIFO/status/IRQ cleanup on
...
class i3c_ibi_controller_rx_reset_flush_test extends i3c_ibi_base_test;
  `uvm_component_utils(i3c_ibi_controller_rx_reset_flush_test)

  function new(string name = "i3c_ibi_controller_rx_reset_flush_test",
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (cfg.ibi_dut_role != I3C_IBI_DUT_CONTROLLER)
      `uvm_fatal("IBI_QUEUE_CLEAR_TEST_ROLE",
                 "i3c_ibi_controller_rx_reset_flush_test cannot run as DUT target")
  ...
  virtual function i3c_base_vseq create_vseq();
    return i3c_ibi_controller_rx_reset_flush_vseq::type_id::create("vseq");
  endfunction
endclass : i3c_ibi_controller_rx_reset_flush_test

`endif // I3C_IBI_CONTROLLER_RX_RESET_FLUSH_TEST_SV
