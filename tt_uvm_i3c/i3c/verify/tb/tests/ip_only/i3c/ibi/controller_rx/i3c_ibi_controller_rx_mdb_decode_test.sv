...
//
// File        : i3c_ibi_controller_rx_mdb_decode_test.sv
...
`ifndef I3C_IBI_CONTROLLER_RX_MDB_DECODE_TEST_SV
`define I3C_IBI_CONTROLLER_RX_MDB_DECODE_TEST_SV
...
class i3c_ibi_controller_rx_mdb_decode_test extends i3c_ibi_base_test;
  `uvm_component_utils(i3c_ibi_controller_rx_mdb_decode_test)

  function new(string name = "i3c_ibi_controller_rx_mdb_decode_test",
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (cfg.ibi_dut_role != I3C_IBI_DUT_CONTROLLER)
      `uvm_fatal("IBI_MDB_TEST_ROLE",
                 "i3c_ibi_controller_rx_mdb_decode_test requires DUT Controller")
    cfg.ibi_bcr = 8'h06;
  ...
  virtual function i3c_base_vseq create_vseq();
    return i3c_ibi_controller_rx_mdb_decode_vseq::type_id::create("vseq");
  endfunction
endclass : i3c_ibi_controller_rx_mdb_decode_test

`endif // I3C_IBI_CONTROLLER_RX_MDB_DECODE_TEST_SV
