...
//
// File        : smc_i3c_ibi_target_tx_multi_target_test.sv
...
`ifndef SMC_I3C_IBI_TARGET_TX_MULTI_TARGET_TEST_SV
`define SMC_I3C_IBI_TARGET_TX_MULTI_TARGET_TEST_SV

class smc_i3c_ibi_target_tx_multi_target_test extends smc_i3c_ibi_base_test;
  `uvm_component_utils(smc_i3c_ibi_target_tx_multi_target_test)

  function new(string name = "smc_i3c_ibi_target_tx_multi_target_test",
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (cfg.ibi_dut_role != SMC_I3C_IBI_DUT_TARGET)
      `uvm_fatal("IBI_MULTI_ROLE",
                 "smc_i3c_ibi_target_tx_multi_target_test requires DUT-Target role")
  ...
  virtual function smc_peripherals_base_vseq create_vseq();
    return smc_i3c_ibi_target_tx_multi_target_vseq::type_id::create("vseq");
  endfunction
endclass : smc_i3c_ibi_target_tx_multi_target_test

`endif // SMC_I3C_IBI_TARGET_TX_MULTI_TARGET_TEST_SV
