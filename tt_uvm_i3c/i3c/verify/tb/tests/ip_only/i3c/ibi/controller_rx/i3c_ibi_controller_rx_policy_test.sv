...
//
// File        : i3c_ibi_controller_rx_policy_test.sv
...
`ifndef I3C_IBI_CONTROLLER_RX_POLICY_TEST_SV
`define I3C_IBI_CONTROLLER_RX_POLICY_TEST_SV
...
class i3c_ibi_controller_rx_policy_test extends
    i3c_ibi_controller_rx_basic_test;
  `uvm_component_utils(i3c_ibi_controller_rx_policy_test)

  function new(string name = "i3c_ibi_controller_rx_policy_test",
               uvm_component parent = null);
    super.new(name, parent);
  endfunction

  virtual function i3c_base_vseq create_vseq();
    return i3c_ibi_controller_rx_policy_vseq::type_id::create("vseq");
  endfunction
endclass : i3c_ibi_controller_rx_policy_test

`endif // I3C_IBI_CONTROLLER_RX_POLICY_TEST_SV
