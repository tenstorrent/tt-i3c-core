...
//
// File        : smc_i3c_ibi_controller_rx_fifo_irq_test.sv
...
`ifndef SMC_I3C_IBI_CONTROLLER_RX_FIFO_IRQ_TEST_SV
`define SMC_I3C_IBI_CONTROLLER_RX_FIFO_IRQ_TEST_SV
...
class smc_i3c_ibi_controller_rx_fifo_irq_test extends
    smc_i3c_ibi_controller_rx_basic_test;
  `uvm_component_utils(smc_i3c_ibi_controller_rx_fifo_irq_test)

  function new(string name = "smc_i3c_ibi_controller_rx_fifo_irq_test",
...
endclass : smc_i3c_ibi_controller_rx_fifo_irq_test

`endif // SMC_I3C_IBI_CONTROLLER_RX_FIFO_IRQ_TEST_SV
