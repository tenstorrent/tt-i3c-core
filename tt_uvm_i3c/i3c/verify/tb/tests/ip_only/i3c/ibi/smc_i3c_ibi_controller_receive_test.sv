...
//
// File        : smc_i3c_ibi_controller_receive_test.sv
...
`ifndef SMC_I3C_IBI_CONTROLLER_RECEIVE_TEST_SV
`define SMC_I3C_IBI_CONTROLLER_RECEIVE_TEST_SV
...
class smc_i3c_ibi_controller_receive_test extends smc_i3c_ibi_base_test;
  `uvm_component_utils(smc_i3c_ibi_controller_receive_test)

  function new(string name = "smc_i3c_ibi_controller_receive_test",
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (cfg.ibi_dut_role != SMC_I3C_IBI_DUT_CONTROLLER)
      `uvm_fatal("IBI_CTRL_TEST_ROLE",
                 "smc_i3c_ibi_controller_receive_test cannot run as DUT target")
  ...
  virtual function smc_peripherals_base_vseq create_vseq();
    return smc_i3c_ibi_controller_receive_vseq::type_id::create("vseq");
  endfunction
endclass : smc_i3c_ibi_controller_receive_test

`endif // SMC_I3C_IBI_CONTROLLER_RECEIVE_TEST_SV
