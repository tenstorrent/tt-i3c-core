...
//
// File        : smc_i3c_ibi_controller_rx_multi_target_test.sv
...
`ifndef SMC_I3C_IBI_CONTROLLER_RX_MULTI_TARGET_TEST_SV
`define SMC_I3C_IBI_CONTROLLER_RX_MULTI_TARGET_TEST_SV

class smc_i3c_ibi_controller_rx_multi_target_test extends
    smc_i3c_ibi_controller_rx_basic_test;
  `uvm_component_utils(smc_i3c_ibi_controller_rx_multi_target_test)

  function new(string name = "smc_i3c_ibi_controller_rx_multi_target_test",
  ...
  virtual function smc_peripherals_base_vseq create_vseq();
    return smc_i3c_ibi_controller_rx_multi_target_vseq::type_id::create(
      "vseq");
  endfunction
endclass : smc_i3c_ibi_controller_rx_multi_target_test

`endif // SMC_I3C_IBI_CONTROLLER_RX_MULTI_TARGET_TEST_SV
