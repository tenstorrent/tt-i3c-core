...
//
// File        : smc_i3c_ibi_controller_rx_policy_test.sv
...
`ifndef SMC_I3C_IBI_CONTROLLER_RX_POLICY_TEST_SV
`define SMC_I3C_IBI_CONTROLLER_RX_POLICY_TEST_SV
...
//      two runtime modes selected with +IBI_POLICY_RUN_ALL and
//      +IBI_POLICY_CASE:
...
class smc_i3c_ibi_controller_rx_policy_test extends
    smc_i3c_ibi_controller_rx_basic_test;
  `uvm_component_utils(smc_i3c_ibi_controller_rx_policy_test)

  function new(string name = "smc_i3c_ibi_controller_rx_policy_test",
               uvm_component parent = null);
    super.new(name, parent);
  endfunction

  virtual function smc_peripherals_base_vseq create_vseq();
    return smc_i3c_ibi_controller_rx_policy_vseq::type_id::create("vseq");
  endfunction
endclass : smc_i3c_ibi_controller_rx_policy_test

`endif // SMC_I3C_IBI_CONTROLLER_RX_POLICY_TEST_SV
