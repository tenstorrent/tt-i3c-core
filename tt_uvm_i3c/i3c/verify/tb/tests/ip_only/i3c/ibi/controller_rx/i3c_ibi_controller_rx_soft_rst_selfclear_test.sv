...
//
// File        : i3c_ibi_controller_rx_soft_rst_selfclear_test.sv
...
`ifndef I3C_IBI_CONTROLLER_RX_SOFT_RST_SELFCLEAR_TEST_SV
`define I3C_IBI_CONTROLLER_RX_SOFT_RST_SELFCLEAR_TEST_SV
...
// contract.
class i3c_ibi_controller_rx_soft_rst_selfclear_test extends i3c_ibi_base_test;
  `uvm_component_utils(i3c_ibi_controller_rx_soft_rst_selfclear_test)

  function new(string name = "i3c_ibi_controller_rx_soft_rst_selfclear_test",
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (cfg.ibi_dut_role != I3C_IBI_DUT_CONTROLLER)
      `uvm_fatal("IBI_SOFT_RST_TEST_ROLE",
                 "i3c_ibi_controller_rx_soft_rst_selfclear_test cannot run as DUT target")
    ...
    // (i3c_ibi_controller_scoreboard.sv check_phase). Left enabled rather
  ...
  virtual function i3c_base_vseq create_vseq();
    return i3c_ibi_controller_rx_soft_rst_selfclear_vseq::type_id::create("vseq");
  endfunction
endclass : i3c_ibi_controller_rx_soft_rst_selfclear_test

`endif // I3C_IBI_CONTROLLER_RX_SOFT_RST_SELFCLEAR_TEST_SV
