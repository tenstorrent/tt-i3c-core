...
//
// File        : smc_i3c_ibi_target_tx_dut_loss_test.sv
// Description : DUT-Target loses IBI arbitration and retries its descriptor.
// Authors     : Huynh Pham Anh Duy, Thai Hai Dang
// Date        : 2026-08-12
// *****************************************************************************

`ifndef SMC_I3C_IBI_TARGET_TX_DUT_LOSS_TEST_SV
`define SMC_I3C_IBI_TARGET_TX_DUT_LOSS_TEST_SV

class smc_i3c_ibi_target_tx_dut_loss_test extends smc_i3c_ibi_base_test;
  `uvm_component_utils(smc_i3c_ibi_target_tx_dut_loss_test)

  function new(string name = "smc_i3c_ibi_target_tx_dut_loss_test",
  ...
  virtual function smc_peripherals_base_vseq create_vseq();
    return smc_i3c_ibi_target_tx_dut_loss_vseq::type_id::create("vseq");
  endfunction
endclass : smc_i3c_ibi_target_tx_dut_loss_test
