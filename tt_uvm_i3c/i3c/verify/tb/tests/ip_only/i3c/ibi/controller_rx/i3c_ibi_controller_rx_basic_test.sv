...
//
// File        : i3c_ibi_controller_rx_basic_test.sv
...
`ifndef I3C_IBI_CONTROLLER_RX_BASIC_TEST_SV
`define I3C_IBI_CONTROLLER_RX_BASIC_TEST_SV
...
class i3c_ibi_controller_rx_basic_test extends i3c_ibi_base_test;
  `uvm_component_utils(i3c_ibi_controller_rx_basic_test)

  function new(string name = "i3c_ibi_controller_rx_basic_test",
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    if (cfg.ibi_dut_role != I3C_IBI_DUT_CONTROLLER)
      `uvm_fatal("IBI_CTRL_TEST_ROLE",
                 "i3c_ibi_controller_rx_basic_test cannot run as DUT target")
  ...
  virtual function i3c_base_vseq create_vseq();
    return i3c_ibi_controller_rx_basic_vseq::type_id::create("vseq");
  endfunction
endclass : i3c_ibi_controller_rx_basic_test

`endif // I3C_IBI_CONTROLLER_RX_BASIC_TEST_SV
