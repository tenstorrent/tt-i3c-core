...
(
    ...
    // Suppress IBI-specific physical-bus assertions while a timing-context
    // test deliberately runs a non-IBI sentinel transfer. Default low keeps
    // those assertions active in every other Controller-RX test.
    logic i3c_controller_ibi_sva_suppress = 1'b0;
    ...
    logic i3c_sva_queue_role = 1'b0;
    logic i3c_sva_queue_irq_enabled = 1'b0;

    longint unsigned i3c_sva_arbitration_seq = 0;
    logic [3:0] i3c_sva_requester_active = '0;
    logic [3:0] i3c_sva_requester_winner = '0;
    logic [3:0] i3c_sva_requester_released = '0;

    longint unsigned i3c_sva_recovery_seq = 0;
    logic i3c_sva_recovery_role = 1'b0;
    logic [2:0] i3c_sva_recovery_cause = 3'd0;
    logic [1:0] i3c_sva_recovery_result = 2'd0;
    logic i3c_sva_recovery_trigger_seen = 1'b0;
    logic i3c_sva_recovery_queue_empty = 1'b0;
    logic i3c_sva_recovery_irq_low = 1'b0;
    logic i3c_sva_recovery_bus_idle = 1'b0;
    logic i3c_sva_recovery_followup_expected = 1'b0;
    logic i3c_sva_recovery_forward_progress = 1'b0;
