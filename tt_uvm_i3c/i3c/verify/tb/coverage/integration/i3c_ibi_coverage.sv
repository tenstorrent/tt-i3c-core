...
`ifndef I3C_IBI_COVERAGE_SV
`define I3C_IBI_COVERAGE_SV

class i3c_ibi_coverage extends uvm_subscriber #(i3c_ibi_item);
  `uvm_component_utils(i3c_ibi_coverage)

  i3c_ibi_attempt_coverage    attempt_cov;
  i3c_ibi_completion_coverage completion_cov;
  i3c_ibi_queue_irq_coverage  queue_irq_cov;
  i3c_ibi_recovery_coverage   recovery_cov;

  function new(string name = "i3c_ibi_coverage",
  ...
  virtual function void build_phase(uvm_phase phase);
    ...
    attempt_cov    = i3c_ibi_attempt_coverage::type_id::create("attempt_cov");
    completion_cov = i3c_ibi_completion_coverage::type_id::create("completion_cov");
    queue_irq_cov  = i3c_ibi_queue_irq_coverage::type_id::create("queue_irq_cov");
    recovery_cov   = i3c_ibi_recovery_coverage::type_id::create("recovery_cov");
  endfunction

  virtual function void write(i3c_ibi_item t);
    if (t == null) begin
...
endclass : i3c_ibi_coverage

`endif // I3C_IBI_COVERAGE_SV
