...
//
// File        : i3c_ibi_blocked_coverage.sv
// Description : Functional coverage for blocked I3C IBI requests.
// Authors     : Huynh Pham Anh Duy, Thai Hai Dang
// Date        : 2026-09-08
//
// *****************************************************************************
`ifndef I3C_IBI_BLOCKED_COVERAGE_SV
`define I3C_IBI_BLOCKED_COVERAGE_SV

class i3c_ibi_blocked_coverage extends uvm_object;
  `uvm_object_utils(i3c_ibi_blocked_coverage)
  ...
  function new(string name = "i3c_ibi_blocked_coverage");
    super.new(name);
    cg_ibi_blocked = new();
  endfunction
