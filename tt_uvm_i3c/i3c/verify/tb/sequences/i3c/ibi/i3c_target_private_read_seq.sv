...
//
// File        : i3c_target_private_read_seq.sv
...
`ifndef I3C_TARGET_PRIVATE_READ_SEQ_SV
`define I3C_TARGET_PRIVATE_READ_SEQ_SV
...
class i3c_target_private_read_seq extends
    uvm_sequence #(i3c_seq_item, i3c_seq_item);
  `uvm_object_utils(i3c_target_private_read_seq)
  ...
  function new(string name = "i3c_target_private_read_seq");
    super.new(name);
  ...
  endtask
endclass : i3c_target_private_read_seq

`endif // I3C_TARGET_PRIVATE_READ_SEQ_SV
