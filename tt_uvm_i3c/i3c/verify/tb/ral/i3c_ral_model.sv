...
class i3c_ral_model extends I3CCSR;
    function new(string name = "i3c_ral_model");
        super.new(name);
    endfunction

    virtual function void build();
        // The native root map is represented as a 32-bit little-endian
        // AXI-Lite frontdoor. Register submaps retain their native offsets.
