package i3c_vip_pkg;
  ...
  typedef i3c_vip_types_pkg::i2c_timing_t i2c_timing_t;
  ...
  typedef i3c_vip_types_pkg::i3c_timing_t i3c_timing_t;
  ...
  // package sources
  `include "core/i3c_item.sv"
  `include "core/i3c_seq_item.sv"
  `include "core/i3c_agent_cfg.sv"
  `include "agent/i3c_monitor.sv"
  `include "agent/i3c_driver.sv"
  `include "agent/i3c_sequencer.sv"
  `include "agent/i3c_agent.sv"
  `include "sequences/i3c_seq_list.sv"

endpackage: i3c_vip_pkg
